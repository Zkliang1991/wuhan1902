...
<script>
    export default {
        ...
        data() {
            return {
                touxiang: require("@/assets/images/photo.jpeg")
            }
        },
        // mounted() {
        ...
        //     } else {
        //         this.touxiang = require("@/assets/images/photo.jpeg");
        //     }
        // },
        methods: {
            uploadImg() {
            ...
            shangchuan() {
                ...
                //     }).then(res => {
                //         console.log(res);
                //         this.touxiang = res.data.avatarurl.replace(/server/, 'http://localhost:3000/');
